...
const Banner = () => {
  ...
  >
    <div className="mx-auto max-w-xl text-center">
      <h1 className= {`${dark?'bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl text-transparent sm:text-5xl':'text-3xl  sm:text-5xl'} font-extrabold`}>
        Understand User Flow.
        <strong className={`${dark?'bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl text-transparent sm:text-5xl' : 'text-red-700'} font-extrabold sm:block`}>
          Increase Conversion.
        </strong>
      </h1>
